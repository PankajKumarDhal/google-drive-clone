      ...
      {user ? (
        ...
        <div className="loginWrap">
          <div className="loginHeader">
            ...
            <button onClick={signIn} className="loginHeaderButton">
              Log In
            </button>
          </div>
          ...
          <div className="loginContent">
            <div className="loginText">
              ...
              <button onClick={signIn} className="loginContentButton">
                Sign Up
              </button>
            </div>
            ...
            <div className="loginImage">
              <img
                src="https://lh3.googleusercontent.com/GAMKSxQD4Rz2FGgskL7102Bem7GDR53mpBeCn-JdS8_HYt4PAWKEPZPjL77twM0wlS1S-FpviFKuKEtmuftq1inPddj0NFihDeFQ=e365-pa-nu-rw-w720"
                alt="Drive Devices"
              />
            </div>
          </div>
